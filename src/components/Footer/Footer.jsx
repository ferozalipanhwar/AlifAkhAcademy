...
const Footer = () => {
  return (
    <footer className="bg-black text-white py-6 mt-12">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-col items-center justify-between space-y-4 md:space-y-5 ">
        {/* Left Side */}
      ...
      <div className="text-center text-sm mt-4 text-gray-400 mt-6">
